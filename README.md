...
4. Add OAuth scopes `https://www.googleapis.com/auth/drive` (full Drive access - required for creating folders and uploading files), `https://www.googleapis.com/auth/spreadsheets`
